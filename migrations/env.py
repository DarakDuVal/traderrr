...
Configured for SQLAlchemy 2.0 with auto-generate support.
"""
...
# Import all models for auto-generate to detect
...
from app.models.user import User, Role, Permission, APIKey, UserAuditLog
